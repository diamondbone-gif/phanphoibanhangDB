...
class UpdateCustomerRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            | Thông tin nhận diện
            |--------------------------------------------------------------------------
            | Dùng khi customer_source = direct.
            */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            | Thông tin nhận diện
            |--------------------------------------------------------------------------
            | Bắt buộc khi chọn "Khách tự tìm đến".
    ...
    public function messages(): array
    {
        return [
            ...
            'customer_role_id.exists' => 'Vai trò khách hàng không hợp lệ.',
            'customer_status_id.exists' => 'Trạng thái khách hàng không hợp lệ.',
            'ctv_status_id.exists' => 'Trạng thái CTV không hợp lệ.',
            ...
            'customer_source.required' => 'Vui lòng chọn phân loại khách hàng.',
            'customer_source.in' => 'Phân loại khách hàng không hợp lệ.',
            ...
            'referrer_phone.digits_between' => 'Số điện thoại người giới thiệu phải dài từ 9 đến 15 chữ số.',
            'referrer_phone.different' => 'Số điện thoại người giới thiệu không được trùng với số điện thoại khách hàng.',
